...
if ($_POST["m_porson"]) {
    $porson = $_POST["m_porson"];
    $_SESSION['m_porson'] = $porson;
}
...
<body>
    <form action="OTP2.php" method="POST">
        <div class="container">
            <h1>Your payment is <?php echo $price; ?> ₹</h1>
            <h1>Confirm Your Payment</h1>
            <div class="first-row">
                <div class="owner">
                    <h3>Owner</h3>
                    <div class="input-field">
                        <input type="text" name="o_name" required pattern="[A-Z/s]{5,25}" title="Username should be started with uppercase letters.">
                    </div>
                </div>
                <div class="cvv">
                    <h3>CVV</h3>
            ...
            <div class="second-row">
                <div class="card-number">
                    <h3>Card Number</h3>
                    <div class="input-field">
                        <input type="text" name="number" required pattern="[0-9]{13,16}" title="enter valid card number">
                    </div>
                </div>
            </div>
            <div class="third-row">
