...
if (isset($_POST["otp1"])) {
  if (isset($_COOKIE["user"])) {
    if ($_POST["otp_val"] == $_POST["otp"]) {
      ...
      $porson = $_SESSION['m_porson'];
      $user_id = $_SESSION['user'];

      $sql3 = "INSERT INTO `membersheep` (`user_id`, `total_member`) VALUES ('$user_id', '$porson')";
      ...
      <div class="col-md-4 offset-md-4 form">
        <form action="" method="POST" autocomplete="off">
          ...
          <div class="form-group">
            <input class="form-control" type="number" name="otp" placeholder="Enter verification code" required pattern="[0-9]{6}" title="Enter six digit OTP" />
          </div>
          <div class="form-group">
